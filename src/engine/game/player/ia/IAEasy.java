 ...
 *
 */
public class IAEasy extends IAScript implements java.io.Serializable{
	 ...
	 */
	public IAEasy(EntityEngine player, Map map, ArrayList<EntityEngine> players) {
